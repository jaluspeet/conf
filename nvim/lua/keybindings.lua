...
-- debug
vim.keymap.set({ 'n', 'i', 'v' }, "<F1>", require('dap').toggle_breakpoint, { desc = 'Breakpoint' })
vim.keymap.set({ 'n', 'i', 'v' }, "<F2>", require('dap').step_over, { desc = 'Debug Step Over' })
vim.keymap.set({ 'n', 'i', 'v' }, "<F3>", require('dap').step_into, { desc = 'Debug Step Into' })
vim.keymap.set({ 'n', 'i', 'v' }, "<F4>", require('dap').step_out, { desc = 'Debug Step Out' })
vim.keymap.set({ 'n', 'i', 'v' }, "<F5>", require('dap').continue, { desc = 'Debug Continue' })
vim.keymap.set({ 'n', 'i', 'v' }, "<F6>", require('dap').repl.toggle, { desc = 'REPL' })
